// Задача№1.cpp: определяет точку входа для консольного приложения.
//
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	std::cout << "{ ";
	for (int i = 0; i < sizeof(AA) / 2; i++) // sizeof При применении к массиву, результатом является полное число байтов в массиве.
