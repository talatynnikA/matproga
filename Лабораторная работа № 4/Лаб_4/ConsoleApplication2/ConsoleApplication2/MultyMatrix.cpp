...
//–екурсив. ƒно рекурсии достигаетс€ при совпадении значений двух первых параметров ф-ции
...
//ƒинамич.прогр. √лавное отличие - использование массива ћ(работа с ним осущ-с€ с помощью макроса OPTIMALM_M) 
               //дл€ хранени€ промежуточных вычислений.
